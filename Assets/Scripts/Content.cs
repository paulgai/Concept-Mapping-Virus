...
public class Content : MonoBehaviour
{
    ...
    public GameObject NextProposition;
    private void OnEnable()
    {
        GetComponent<RectTransform>().transform.localScale = new Vector3(0.0f, 0.0f, 0.0f);
        Sequence mySequence = DOTween.Sequence();
        this.transform.parent.GetComponent<Image>().color = new Color(1, 1, 1, 0);
        mySequence.Append(this.transform.parent.GetComponent<Image>().DOColor(new Color(1,1,1,0.8f),0.5f));
    ...
    public void BtnPressed() 
    {
        if(NextProposition != null)
            NextProposition.SetActive(true);
